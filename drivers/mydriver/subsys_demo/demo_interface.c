...
int demo_test_setA(struct demo_device *demo, struct demo_ctl_data *demo_ctl)
{
    int err = 0;
...
int demo_test_getA(struct demo_device *demo, struct demo_ctl_data *demo_ctl)
{
    int err = 0;
